...
export default function LetterGlitch({
  glitchColors = ['#f97316', '#60a5fa', '#1e293b'],
  className = '',
  glitchSpeed = 50,
  ...
  const drawLetters = () => {
    ...
    const width = parent ? parent.clientWidth : canvasRef.current.width;
    const height = parent ? parent.clientHeight : canvasRef.current.height;
